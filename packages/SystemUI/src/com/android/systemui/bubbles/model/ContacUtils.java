...
* Also modified to be used in Metallium OS Project(c)
*
...
public class ContactUtils {
	...
	public static Bitmap getContactIcon(long contactID, Context ctx){
		...
		if (contactThumb != null) {
			...
			Drawable myDrawable = ctx.getResources().getDrawable(com.android.systemui.R.drawable.no_contact);
	...
	public static void OpenContact(Context ctx, Contact mContact){
		Intent intent = new Intent(Intent.ACTION_VIEW);
		Uri uri = Uri.withAppendedPath(ContactsContract.Contacts.CONTENT_URI, String.valueOf(mContact.getContactID()));
		intent.setData(uri);
