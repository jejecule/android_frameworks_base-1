 ...
 * parts of the code belong to THE METALLIUM OS Project
 *
...
public class MetaGesturesListener implements PointerEventListener {
    private static final String TAG = "MetaGestures";
    ...
    public MetaGesturesListener(Context paramContext, Callbacks callbacks) {
