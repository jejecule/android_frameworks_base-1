...
public final class Settings {
    ...
    /**
     * @hide -private call() method on SettingsProvider to read 'meta' table.
     */
    public static final String CALL_METHOD_GET_METALLIUM = "GET_metallium";
    ...
    /** @hide - Private call() method to write to 'metallium' table */
    public static final String CALL_METHOD_PUT_METALLIUM = "PUT_metallium";
    ...
    /**
     * Metallium settings, Containing Metallium specific preferences.
     * This holds simple name/value pairs. There are convenience
     * functions for accessing individual settings entries.
     */
    public static final class METALLIUM extends NameValueTable {
        public static final String SYS_PROP_SETTING_VERSION = "sys.settings_system_version";
         ...
         */
        public static final Uri CONTENT_URI =
            Uri.parse("content://" + AUTHORITY + "/metallium");
        private static final NameValueCache sNameValueCache = new NameValueCache(
                SYS_PROP_SETTING_VERSION,
                CONTENT_URI,
                CALL_METHOD_GET_METALLIUM,
                CALL_METHOD_PUT_METALLIUM);
         ...
         * @param resolver to access the database with
         * @param name to store
         * @param value o associate with the name
         * @return true if the value was set, false on database errors
         */
        public static boolean putString(ContentResolver resolver, String name, String value) {
            return putStringForUser(resolver, name, value, UserHandle.myUserId());
